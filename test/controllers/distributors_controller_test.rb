...
class DistributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distributor" do
    assert_difference('Distributor.count') do
      post distributors_url, params: { distributor: {  } }
    end

    assert_redirected_to distributor_path(Distributor.last)
  end
  ...
  test "should update distributor" do
    patch distributor_url(@distributor), params: { distributor: {  } }
    assert_redirected_to distributor_path(@distributor)
  end
